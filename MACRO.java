...
class MACRO {
    static String mnt[][] = new String[5][3]; // 5 mac
    static String ala[][] = new String[10][2]; //  2 arg
    static String mdt[][] = new String[20][1]; //  4 LOC
    ...
    public static void main(String args[]) {
        ...
        System.out.println("i | macro | index in MDT\n");
        display(mnt, mntc, 3);
        System.out.println("\n");
